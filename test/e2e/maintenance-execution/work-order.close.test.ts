...
describe('Work Order Close (e2e, HTTP)', () => {
  ...
  it('closes a work order and forwards enriched payload to microservice', async () => {
    ...
    expect(response.body.workOrder.woStatusCode).toBe('CLOSED');
    expect(response.body.workOrder.closedDate).toBe('2026-08-07T16:00:00.000Z');
  });
