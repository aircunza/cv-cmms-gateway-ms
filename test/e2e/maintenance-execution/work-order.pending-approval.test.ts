...
describe('Work Order Pending Approval (e2e, HTTP)', () => {
  ...
  it('marks a work order as pending approval and forwards enriched payload to microservice', async () => {
    ...
    const response = await request(app.getHttpServer())
      .patch('/work-orders/1001/pending-approval')
    ...
    expect(response.body.workOrder.woStatusCode).toBe('UNRELEASED');
  });
