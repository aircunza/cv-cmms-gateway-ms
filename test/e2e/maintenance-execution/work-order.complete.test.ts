...
describe('Work Order Complete (e2e, HTTP)', () => {
  ...
  it('completes a work order and forwards enriched payload to microservice', async () => {
    ...
    const response = await request(app.getHttpServer())
      .patch('/work-orders/1001/complete')
    ...
    expect(response.body.workOrder.woStatusCode).toBe('COMPLETED');
  });
