        ...
        roles: [
          {
            ...
            permissions: ['mnt.work.request.cancel', 'mnt.work.orders.cancel'],
...
describe('Work Request Cancel (e2e, HTTP)', () => {
  ...
  it('cancels a work request and forwards enriched payload to microservice', async () => {
    const microserviceResponse = {
      workRequest: {
        ...
        canceledAt: '2026-08-07T16:00:00.000Z',
        organizationCode: 'E2E_ORG_001',
        organizationName: 'E2E Organization',
    ...
    const response = await request(app.getHttpServer())
      .patch('/work-requests/900000001/cancel')
    ...
    expect(mockNatsClient.send).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        ...
        userPermissions: ['mnt.work.request.cancel', 'mnt.work.orders.cancel'],
    ...
    expect(response.body.workRequest.statusCode).toBe('CANCELED');
    expect(response.body.workRequest.canceledAt).toBe(
