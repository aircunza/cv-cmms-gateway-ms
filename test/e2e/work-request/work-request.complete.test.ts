        ...
        roles: [
          {
            ...
            permissions: ['mnt.work.request.complete'],
...
describe('Work Request Complete (e2e, HTTP)', () => {
  ...
  it('completes a work request and forwards enriched payload to microservice', async () => {
    const microserviceResponse = {
      workRequest: {
        ...
        completedAt: '2026-08-07T15:45:00.000Z',
    ...
    const response = await request(app.getHttpServer())
      .patch('/work-requests/900000001/complete')
    ...
    expect(response.body.workRequest.statusCode).toBe('COMPLETED');
    expect(response.body.workRequest.completedAt).toBe(
      '2026-08-07T15:45:00.000Z',
    );
  });
